...
export default function HomePage() {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <link rel="canonical" href="https://www.geracodigo.com.br/" />
      ...
      <section className="text-center mb-16">
        ...
        <p className="inline-flex items-center gap-2 bg-indigo-50 text-indigo-700 px-4 py-2 rounded-full text-sm font-medium">
          <span aria-hidden="true">🔒</span> Gerado direto no seu navegador — seus dados nunca saem do seu computador
        </p>
      </section>

      <section aria-label="Ferramentas disponíveis">
        <ul role="list" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 mb-16">
          {tools.map((tool) => (
            <li key={tool.href}>
              <Link
                href={tool.href}
      ...
      <section aria-labelledby="why-geracode" className="bg-white rounded-xl border border-gray-200 p-8 text-center">
        <h2 id="why-geracode" className="text-2xl font-bold text-gray-900 mb-4">Por que usar o GeraCode?</h2>
